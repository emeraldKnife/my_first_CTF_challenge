...
This will lead us with the message `axpwagjt`. This is not the final code. The hint given is `33355588 -> ilu`. This hints towards the conversion using the dial pad. So, `axpwagjt` becomes `299792458`, which is the password.

<br>
<br>
Now for the next CTF (web exploitation). We will enter the password and exploit the web page. This can be done using SQL injection.
<br>
